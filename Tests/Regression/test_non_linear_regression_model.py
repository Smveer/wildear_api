...
# Init functions
rml.create_polynomial_regression_model.restype = ctypes.c_void_p
rml.train_polynomial_regression_model.argtypes = [
    ctypes.c_void_p,
...
rml.delete_polynomial_regression_model.argtypes = [
    ctypes.c_void_p
]


# Create model
model = rml.create_polynomial_regression_model()
